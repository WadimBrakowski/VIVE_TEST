...
namespace Wave.OpenXR.Toolkit.Samples.FacialTracking
{
    ...
    public class LipExpText : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            m_Text.text = m_LipExpression.ToString() + ": " + FacialTrackingData.LipExpression((XrLipExpressionHTC)m_LipExpression);
        }
    }
}
